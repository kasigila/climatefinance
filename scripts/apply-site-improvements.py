...
PAGE_META = {
    ...
    "financial-modelling.php.html": {"title": "Financial Modelling | Africa Climate Finance", "description": "Feasibility models, cashflow projections, and GCF-ready financial structures.", "schema": "Service", "service": "Financial Modelling"},
    "gender-assessment.php.html": {"title": "Gender Assessment | Africa Climate Finance", "description": "GCF-compliant gender action plans and women-led enterprise assessments.", "schema": "Service", "service": "Gender Assessment"},
    ...
    "kenneth.php.html": {"title": "Kenneth Kasigila | Africa Climate Finance", "description": "Profile of Kenneth Kasigila, Group CEO of Africa Climate Finance and GCF NDA Focal Point.", "schema": "Person", "person": "Kenneth Kasigila"},
    "kenneth.html": {"title": "Kenneth Kasigila | Africa Climate Finance", "description": "Profile of Kenneth Kasigila, Group CEO of Africa Climate Finance and GCF NDA Focal Point.", "schema": "Person", "person": "Kenneth Kasigila"},
